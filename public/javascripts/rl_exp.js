	...
	*/
	var rl_exp = {
		...
		text:[			/*表情包title文字，自己补充*/
			[
				'高兴','给力','色','恭喜发财','强','测试','测试','测试','测试','测试','测试','测试','测试','测试','测试','测试','测试','测试','测试','测试',
		...
		init:function(){
			...
			$("#rl_exp_btn1").bind('click',function(){
				var w = $(this).position();
				$('#rl_bq1').css({left:w.left,top:w.top+30}).fadeIn(400);
			});

			$('#rl_bq1 a.close').bind('click',function(){
				$('#rl_bq1').fadeOut(rl_exp.pace);
			});
